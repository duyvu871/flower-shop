...
const GreyBadge = ({ children }) => {
    return (
        <span
            className={
                "px-3 py-1 text-xs font-medium rounded-md bg-gray-500/10 text-gray-500"
            }
        >
            {children}
        </span>
    ...
    return (
        <tbody className={'className={"divide-y divide-default-200"}'}>
            {data.map((item, data_index) => (
                <tr
                    className={"border border-gray-200 border-0 border-b-1"}
                    key={"row" + data_index}
                >
                    {isShowSelect && (
                        <td className={"px-6 py-4 whitespace-nowrap text-base"}>
                            <input
                                type="checkbox"
                                onChange={() =>
                                    setSelectedItems(selectedItems[data_index])
                                }
                    ...
                    {keys.map((key, index) => {
                        ...
                        if (key === "action") {
                            return (
                                <td
                                    key={"td" + index}
                                    className={
                                        "px-3 py-4 whitespace-nowrap text-base cursor-pointer"
                                    }
                                >
                                    <Button
                                        className={
                                    ...
                                    >
                                        {item[key].map((order, index) => (
                                            <div
                                                key={"order" + index}
                                                className={
                                                    "flex flex-row justify-start items-center gap-1 w-full"
                                                }
                                            >
                                                <span
                                                    className={
                                                        "text-base font-semibold line-clamp-2 text-gray-500"
                                                    }
                                                >
                                                    {order.name}
                                                </span>
                        ...
                        if (key === "userId") {
                            return (
                                <td
                                    key={"td" + index}
                                    className={
                                        "px-3 py-4 whitespace-nowrap text-gray-600 "
                                    }
                                >
                                    <span
                                        className={
                        ...
                        if (key === "price") {
                            return (
                                <td
                                    key={"td" + index}
                                    className={
                                        "px-3 py-4 whitespace-nowrap text-base font-semibold"
                                    }
                                >
                        ...
                        if (key === "image") {
                            return (
                                <td
                                    key={"td" + index}
                                    className={
                                        "px-3 py-4 flex justify-center items-center text-base"
                                    }
                                >
                                    <Image
                                        shadow="sm"
                        ...
                        if (actions[index] === "clamp2") {
                            return (
                                <td
                                    key={"td" + index}
                                    className={
                                        "px-3 py-4  text-base line-clamp-2"
                                    }
                                >
                        ...
                        return (
                            <td
                                key={"td" + index}
                                className={
                                    "px-3 py-4 whitespace-break-spaces text-base max-w-xl "
                                }
                            >
