    ...
    return (
        <div className={"p-6  w-full"}>
            ...
            >
                ...
                <div
                    className={
                        "flex flex-row justify-end items-center gap-4 w-full"
                    }
                >
                    <button
                        className={tw(
            ...
            <div className={"grid grid-cols-1"}>
                <div
                    className={
                        "border rounded-lg border-default-200 bg-gray-50"
                    }
                >
                    <div
                        className={
                            "px-6 py-4 overflow-hidden flex flex-row justify-between items-center"
                        }
                    >
                        <div
                            className={
                    ...
                    <div className={"relative overflow-x-auto"}>
                        <div className={"min-w-full inline-block align-middle"}>
                            <div className={"overflow-hidden"}>
                                <table
                                    className={
                                        "min-w-full divide-y divide-default-200"
                                    }
                                >
                                                ...
                                                if (item.title === "Select") {
                                                    return (
                                                        <th
                                                            key={index}
                                                            className={
                                                                "px-6 py-3 text-xs text-gray-500"
                                                            }
                                                        >
                                                            <input
                                                                type="checkbox"
                                                ...
                                                if (item.key === "takeNote") {
                                                    return (
                                                        <th
                                                            key={index}
                                                            className={
                                                                "px-6 py-3 text-xs text-gray-500 min-w-[300px]"
                                                            }
                                                        >
                                                            {item.title}
                                                        </th>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            {item.isSort && (
                                                                <FaSort
                                                                    className={
                                                                        "cursor-pointer hover:text-blue-600 hover:scale-110"
                                                                    }
                                                                    onClick={() => {
                                                                        if (
                                                                            currentSort.key ===
                                    ...
                                    {isLoading ? (
                                        ...
                                        <TableBody
                                            keys={headerTable.map(
                                                (item) => item.key,
                                            )}
                                            actions={headerTable.map(
                                                (item) => item.action,
                                            )}
                                            page={currentPage - 1}
                                            rowsPerPage={10}
