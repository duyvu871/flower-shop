...
function ProfileScreen({}: ProfileScreenProps) {
    ...
    return (
        <div className={"w-full h-full flex flex-col justify-center items-center "}>
            <div className={"w-full h-fit flex flex-row justify-start items-center gap-3 border-[1px] border-gray-200 p-5 pb-8"}>
                <Avatar
                    showFallback
                    isBordered
                    color="warning"
                ...
                <div className={"flex flex-col justify-center items-start"}>
                    ...
                    {userData.isLoyalCustomer ?
                        <span className={"flex flex-row justify-center items-center gap-1 bg-gray-200 rounded-full p-1 px-2 text-[10px]"}>
